...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
	...
	$sqlp="INSERT INTO pharmacist(pharmacist_id,first_name,last_name,staff_id,username,password)
	VALUES($id,'$fname','$lname',$sid,'$user','$pass')";
	if(mysqli_query($con,$sqlp))
	{
	echo "hello";
	header('location:http://localhost/pharmacy/admin_pharmacist.php');
	exit();
	}
	else
	{
...
<p align="right"> Logged in as <b>Phramacist ADMIN</b></p>WELCOME<?php echo $user;?> 
...
<center>
<form action= "admin_pharmacist.php" method= "POST">
	<label> <b> Pharmacist ID</b> </label>
	<input type="text" placeholder="Pharmacist ID" required="required" name="id"><br>
