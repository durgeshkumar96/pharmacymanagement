...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
	...
	$sqlp="INSERT INTO cashier (cashier_id,first_name,last_name,staff_id,username,password)
	VALUES($id,'$fname','$lname',$sid,'$user','$pass')";
	if(mysqli_query($con,$sqlp))
	{
	echo "hello";
	header('location:http://localhost/pharmacy/admin_cashier.php');
	exit();
	}
	else
	{
...
<p align="right"> Logged in as <b>Cashier Admin</b></p>WELCOME<?php echo $user;?> 
...
<form action= "admin_cashier.php" method= "POST">
	<label> <b> Cashier ID</b> </label>
	<input type="text" placeholder="Cashier ID" required="required" name="id"><br>
